            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center mt-4">
                <label className="mr-2">
                  Professor
                  <input type="checkbox" checked={isProfessor} onChange={() => setIsProfessor(!isProfessor)} className="ml-2" />
                </label>
                <label className="ml-4">
                  Aluno
                  <input type="checkbox" checked={isStudent} onChange={() => setIsStudent(!isStudent)} className="ml-2" />
                </label>
              </div>
              <div className="mt-6">
